...
;产品配置
;==================================================
!define    PRODUCT_NAME                  "YY游戏大厅-盒子版"
...
!define    PRODUCT_DESCRIPTION           "YY游戏大厅-盒子版"
!define    SETUP_MUTEX_NAME              "{A2E2A23D-8779-41F7-A5C6-220907073754}"                              ;防止多进程同时运行
...
!define    PRODUCT_CLIENT_EXE            "yygame.exe;yygrender.exe;yygupdate.exe;yygamecrash.exe;YGLauncher.exe;yg_server_reminder.exe"                                                          ;客户端主进程名，用户安装/卸载之前检测进程是否在运行
!define    PRODUCT_RSO_NAME              "from_lolgamesetup"                                                    ;pas字段rso
...
OutFile    "LOLGameSetup.exe"             ;安装包名字
;InstallDir "$PROGRAMFILES\duowan\${PRODUCT_NAME}" ;默认安装位置
InstallDir "$PROGRAMFILES\duowan\" ;默认安装位置
...
!define PAS_INSTALL_SUCCESS        '"YYGameSetup/success"                "大厅安装/安装成功"'                     ;安装成功
!define PAS_RUN_CLIENT             '"YYGameSetup/success/startup"        "大厅安装/安装成功/启动大厅"'            ;启动客户端
...
!define PAS_UNINSTALL_SUCCESS      '"YYGameSetup/uninstall/success"      "大厅安装/卸载程序/卸载成功"'            ;卸载成功
