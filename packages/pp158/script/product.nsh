...
!define    PRODUCT_DESCRIPTION           "PP158游戏大厅客户端"
...
OutFile    "PP158Game.exe"             ;安装包名字
;InstallDir "$PROGRAMFILES\duowan\${PRODUCT_NAME}" ;默认安装位置
InstallDir "$APPDATA\PP158Game" ;默认安装位置
...
!define PAS_PRODUCT_NAME           "pp158game"
;安装上报
