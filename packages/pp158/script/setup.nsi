...
Function OnBtnClickInstall
	...
	ReadINIStr $1 "$INSTDIR\Version.ini" "PP158Game" "NewVersion"
	${If} "$1" == ""
		WriteINIStr "$INSTDIR\Version.ini" "PP158Game" "NewVersion" "${PRODUCT_VERSION}"
		WriteINIStr "$INSTDIR\Version.ini" "PP158Game" "OldVersion" "${PRODUCT_VERSION}"
		WriteINIStr "$INSTDIR\Version.ini" "PP158Game" "Version" "${PRODUCT_VERSION}"
	${Else}
		WriteINIStr "$INSTDIR\Version.ini" "PP158Game" "NewVersion" "${PRODUCT_VERSION}"
		WriteINIStr "$INSTDIR\Version.ini" "PP158Game" "Version" "${PRODUCT_VERSION}"
		WriteINIStr "$INSTDIR\Version.ini" "PP158Game" "OldVersion" "$1"
	${EndIf}
